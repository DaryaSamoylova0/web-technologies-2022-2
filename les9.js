...
function init() {
    ...
    function ListItems(el, data) {
        ...
        {
            let objectE = '';
            objectE += '<div class="list-item list-item_open" data-parent>'
            + this.objectassembly(data)
            + '<div class="list-item__items">'
            for (let item of data.items) {
                if (item.hasChildren) {
                    objectE += this.renderParent(item);
                }
                else{
                    objectE += this.renderChildren(data);
                }
            }
            objectE += '</div>' + '</div>';
            return objectE;
        ...
        this.objectassembly = function (data)
        {
            let objectt = '';
